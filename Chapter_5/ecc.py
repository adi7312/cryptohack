...
def multiplication_task():
    P = Point(curve, 2339, 2213)
    print(P * 7863)

def shared_secret_task():
    n_B = 1829
    Q_A = Point(curve, 815,3190)
    shared_point = Q_A * n_B
    h = SHA1.new()
    h.update(str(shared_point.x).encode("latin-1"))
    print(h.hexdigest())
